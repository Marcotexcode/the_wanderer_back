...
exports.commandCreateService = void 0;
const fs = __importStar(require("fs/promises"));
const path = __importStar(require("path"));
const commandCreateService = (serviceName) => __awaiter(void 0, void 0, void 0, function* () {
...
export const ${serviceNameLower}Service = {
    ...
    yield fs.mkdir(serviceDir);
    yield fs.writeFile(path.join(__dirname, `../services/${serviceNameLower}/${serviceNameLower}.service.ts`), serverCode);
});
exports.commandCreateService = commandCreateService;
